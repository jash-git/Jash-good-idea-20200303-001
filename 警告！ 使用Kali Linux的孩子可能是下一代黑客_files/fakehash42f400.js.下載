...
var i=p.config[t];
if(1!=i.jsLoadState){
if(2==i.jsLoadState||3==i.jsLoadState)return void o();
i.jsLoadState=1;
var n=+new Date,e=l[t+"_js_num"];
e&&(e=e.split("_"),c.setSum(e[0],e[1],1)),u({
url:i.jsLink,
timeout:1e4,
type:"JS",
callback:function(){
...
2==i.jsLoadState,o();
var e=l[t+"_js_suc"];
e&&(e=e.split("_"),c.setSum(e[0],e[1],1));
},
onerror:function(e){
+new Date-n;
i.jsLoadState=3,o();
var s=l[t+"_js_err"],r=l[t+"_js_timeout"],a=l[t+"_js_network"];
if(s&&r&&a)switch(s=s.split("_"),r=r.split("_"),a=a.split("_"),c.setSum(s[0],s[1],1),
1*e){
case 400:
c.setSum(a[0],a[1],1);
break;
...
},e=(window.msg_title||"").html(!1),o=(window.msg_desc||"").html(!1);
n(function(){
...
var n=this.opt,e=this._g,o=n.plugins,s=e._blockPlugin[t]||e._blockPlugin.all,r=0;
if(s&&"function"==typeof s.recv&&(r|=s.recv(t,i),1&r))return!1;
for(var a=0,c=o.length;c>a&&(r|=o[a].recv(t,i),!(2&r));++a);
if(!(4&r)){
