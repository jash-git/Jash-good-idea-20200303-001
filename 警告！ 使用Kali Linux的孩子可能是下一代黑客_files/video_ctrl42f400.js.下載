...
function d(e){
var t=arguments.length<=1||void 0===arguments[1]?0:arguments[1],i=arguments.length<=2||void 0===arguments[2]?N:arguments[2];
p({
url:"/mp/relatedarticle?action=getlist&count="+i+"&begin="+t+"&article_url="+window.encodeURIComponent(location.href)+"&__biz="+window.biz+"&mid="+window.mid+"&idx="+window.idx,
type:"GET",
dataType:"json",
success:function(s){
s&&s.list&&s.list.length>0&&(window.has_related_article=!0);
var d=function(){
if(s&&s.base_resp&&1*s.base_resp.ret===0)if(M=s.article_size||0,0===s.list.length)P?a(0!==t):y.addClass(B,"hide");else{
A.style.display="block";
for(var e=s.list.map(function(e){
...
var t=""+window.parseInt(e.read_num)/1e4,n=t.indexOf(".");
e.read_num_wording=-1===n?t+"万":t.substr(0,n)+"."+t.charAt(n+1)+"万";
}else e.read_num_wording=0===window.parseInt(e.read_num)?"":e.read_num;
return e;
}),d=c.tmpl(u,{
list:e,
reason:W
}),r=n(d),l=0;l<r.length;l++)E.appendChild(r[l].cloneNode(!0));
P?(s.list.length<i||s.article_size<=t+i)&&a(0!==t):s.article_size===i?(Q=!1,y.addClass(B,"hide")):s.article_size>i&&(Q=!0,
y.removeClass(B,"hide"),w.on(B,"click",o)),window.ipados13_font_scale&&v(E,window.ipados13_font_scale/100);
}
};
"function"==typeof e?e("sucess",d):d();
},
error:function(){
...
function r(){
for(var e=document.getElementsByClassName("js_related_item"),n=t(),i=0;i<e.length;i++){
var o=e[i];
1*o.getAttribute("data-hasreport")!==1&&o.clientHeight+o.offsetTop>=n+o.clientHeight/2&&o.clientHeight+o.offsetTop<=n+o.clientHeight/2+g.getInnerHeight()&&!function(e,t){
var n=e.getAttribute("data-url"),i=e.getAttribute("data-time"),o=e.getAttribute("data-recalltype");
e.setAttribute("data-hasreport",1),x.setSum(110809,21,1),j.report(18832,_extends({
Actiontype:1,
Type:1,
Bizuin:f.getQuery("__biz",n),
Msgid:window.parseInt(f.getQuery("mid",n),10)||0,
Itemidx:window.parseInt(f.getQuery("idx",n),10)||0,
Sendtimestamp:window.parseInt(i)||0,
Pos:t+1,
Recalltype:1*o
},U));
}(o,i);
}
M>1&&1*B.getAttribute("data-hasreport")!==1&&B.clientHeight+B.offsetTop>=n+B.clientHeight/2&&B.clientHeight+B.offsetTop<=n+B.clientHeight/2+g.getInnerHeight()&&!function(e){
...
function l(){
i(),s(!0),R+=N,d(function(e,t){
s(!1),"sucess"===e&&t();
},R);
}
function m(){
w.on(E,"click",".js_related_item",function(e){
var t=e.delegatedTarget,n=t.getAttribute("data-url"),i=t.getAttribute("data-time"),o=t.getAttribute("data-recalltype");
...
Pos:1,
Recalltype:1*o
},U)),z.isWechat?_.openUrlWithExtraWebview(n):window.open(n);
...
},!1),w.on(window,"scroll",r),P&&(w.on(S,"click",l),w.on(C,"click",function(){
...
B.style.display="none",T.style.display="",w.off(B,"click",o),w.on(T,"click",o)):A.style.display="none"),
e.parentNode.removeChild(e);
}
});
}
e("biz_common/utils/string/html.js");
var c=e("biz_common/tmpl.js"),p=e("biz_wap/utils/ajax.js"),u=e("appmsg/related_article_tpl.html.js"),_=e("biz_wap/utils/openUrl.js"),w=e("biz_common/dom/event.js"),g=e("common/utils.js"),y=e("biz_common/dom/class.js"),f=e("biz_common/utils/url/parse.js"),b=e("appmsg/i18n.js"),j=e("common/comm_report.js"),h=e("appmsg/related_article_feedback.js"),z=e("biz_wap/utils/mmversion.js"),I=e("biz_wap/utils/device.js"),v=e("appmsg/set_font_size.js").setFontSize,x=e("biz_common/utils/monitor.js"),A=document.getElementById("js_related_area"),E=document.getElementById("js_related"),B=document.getElementById("js_related_load_more"),T=document.getElementById("js_more_article"),S=document.getElementById("js_related_load_more_pc"),k=document.getElementById("js_related_loading_pc"),C=document.getElementById("js_more_article_pc"),H=document.getElementById("js_related_all_pc"),P=I.os.ipad||!z.isIOS&&!z.isAndroid,M=0,Q=!1,U={
Bizuin_from:window.biz,
Msgid_from:window.parseInt(window.mid,10)||0,
Itemidx_from:window.parseInt(window.idx,10)||0,
Scene:window.parseInt(window.source,10)||0,
