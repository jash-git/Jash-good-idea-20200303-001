...
});define("appmsg/fereport.js",["biz_wap/utils/wapsdk.js","biz_common/utils/http.js","appmsg/log.js","biz_common/base64.js","biz_common/utils/monitor.js"],function(e){
"use strict";
function i(){
var e=window.performance||window.msPerformance||window.webkitPerformance;
if(e&&e.timing){
var i,n=e.timing,o=0,u=0,r=window.location.protocol,p=Math.random(),c=1>2*p,_=1>25*p,l=1>100*p,g=1>250*p,f=1>1e3*p,v=1>1e4*p,S=!0;
"https:"==r?(o=18,u=27,S=!1):"http:"==r&&(o=9,u=19);
...
var s=e("biz_wap/utils/wapsdk.js"),t=e("biz_common/utils/http.js"),d=e("appmsg/log.js"),a=e("biz_common/base64.js"),m=e("biz_common/utils/monitor.js"),w=a.toBase64(JSON.stringify({
scene:window.source,
...
var m="";
m=.5>e?"SHA-256":"SHA-1";
for(var u=(new Date).getTime(),r=0;r<n.length;r++)t.push(o(n[r],m));
Promise.all(t).then(function(){
var i=(new Date).getTime(),n=i-u;
s.saveSpeeds({
uin:window.encodeURIComponent(a.toBase64(window.user_uin))||uin,
pid:108,
speeds:{
...
});define("appmsg/fereport_without_localstorage.js",["biz_wap/utils/wapsdk.js","biz_common/utils/http.js","appmsg/log.js","biz_common/base64.js","biz_common/utils/monitor.js"],function(e){
"use strict";
function i(){
var e=window.performance||window.msPerformance||window.webkitPerformance;
if(e&&e.timing){
var i,a=e.timing,w=0,u=0,p=window.location.protocol,r=Math.random(),_=1>2*r,c=1>25*r,l=1>100*r,g=1>250*r,f=1>1e3*r,S=1>1e4*r,B=!0;
"https:"==p?(w=462,u=464,B=!1):"http:"==p&&(w=417,u=463);
...
var R=a.domContentLoadedEventStart-a.navigationStart;
...
var b=n.htmlSize/(a.responseEnd-a.connectStart);
o.saveSpeeds({
sample:f,
uin:window.encodeURIComponent(d.toBase64(window.user_uin))||uin,
pid:w,
...
var o=e("biz_wap/utils/wapsdk.js"),n=e("biz_common/utils/http.js"),s=e("appmsg/log.js"),d=e("biz_common/base64.js"),t=e("biz_common/utils/monitor.js"),m=d.toBase64(JSON.stringify({
scene:window.source,
sessionid:window.sessionid
}));
i();
...
if(g&&t.setAvg(27822,15,g),w&&t.setAvg(27822,17,w),d>=15e3)return void t.setAvg(27822,29,d);
...
p&&t.setAvg(27822,65,p),c&&t.setAvg(27822,67,c),u&&t.setAvg(27822,69,u);
}
}(),function(){
...
return R.length<=0&&x.length<=0&&0==z.length?!1:A&&0!=A.length?!0:(window.__addIdKeyReport&&window.__addIdKeyReport("27613","52",1),
!1);
}
function a(e){
...
for(var s=0;s<A.length;s++)window.reportWeappid.push(A[s].appid);
var m=function(){};
...
var l,c,h=!I.canJumpOnTap||I.isNonWechat,E=document.getElementById("js_pc_weapp_code"),B=document.getElementById("js_weapp_without_auth_dialog_mask"),R=document.getElementById("js_pc_weapp_code_img"),x=document.getElementById("js_pc_weapp_code_des");
...
var K=z.data.infoMap;
if(!K)return void(window.__addIdKeyReport&&window.__addIdKeyReport("27613","52",1));
for(s=0;s<T.length;s++)(function(s){
window.__addIdKeyReport("111535",1);
var j=T[s].appid,A=T[s].path,N=T[s].imageUrl,q=T[s].title,L=T[s].elem,W=K[j];
if(!W)return void(window.__addIdKeyReport&&window.__addIdKeyReport("27613","52",1));
var M=L.tagName.toLowerCase(),P=L.firstChild&&1==L.firstChild.nodeType&&"IMG"===L.firstChild.tagName;
if(P=P||L.firstElementChild&&"IMG"===L.firstElementChild.tagName,"a"!=M)L.innerHTML=v.tmpl(w,{
imageUrl:a(N),
title:a(q),
nickname:a(W.nickname),
avatar:a(W.logo_url)
});else{
if(P){
var U=L.firstChild;
...
if(z.resp&&z.resp.weapp_info&&z.resp.weapp_info.length)for(var H=0;H<z.resp.weapp_info.length;H++)if(z.resp.weapp_info[H].weapp_appid===j&&1===z.resp.weapp_info[H].has_guarantee_flag){
b.addClass(L.getElementsByClassName("guarantee_icon")[0],"show");
break;
}
y.on(L,"tap",function(){
if(m=function(){
...
beforeNonWechatWarn:function(){
d(j,s,W.nickname,q,e);
},
beforeJumpBackupPage:function(){
r(j,s,W.nickname,q,e);
},
...
}),window.__addIdKeyReport&&window.__addIdKeyReport("28307",100),n(j,s,W.nickname,q,3,e,P?2:0),
P&&window.__addIdKeyReport&&window.__addIdKeyReport("28307",115),!1;
},k.isInMiniProgram&&-1===S.indexOf(j)&&k.gtVersion("7.0.5",!0)){
...
if(P&&C.report([2,1,"",img_popup?1:0,window.source,j]),(P||b.hasClass(L,"weapp_text_link")&&(o(L)||i(L)))&&img_popup){
document.getElementById("js_minipro_dialog_head").innerText="即将打开小程序",document.getElementById("js_minipro_dialog_body").innerText=W.nickname;
var p=document.getElementById("js_minipro_dialog");
return p.style.display="block",document.querySelector("body").addEventListener("touchmove",e,{
passive:!1
}),p._appid=j,p._i=s,p._nickname=W.nickname,p._title=q,n(j,s,W.nickname,q,3,1,0),
I.canJumpOnTap&&window.__addIdKeyReport&&window.__addIdKeyReport("28307",114),!1;
}
return m();
},"a"==M),y.on(L,"click",function(e){
e.preventDefault(),e.stopPropagation();
},"a"==M),h&&(y.on(L,"mouseenter",function(){
function e(e){
function t(){
if(!l&&c===s){
E.style.display="block",l=!0;
var e=E.offsetHeight,t=E.offsetWidth;
"a"!=M||P?n>t?(g(E,"right-center"),E.style.left=n-t-m+"px",E.style.top=o+"px"):(g(E),
...
if(e){
var n=u(L),o=_(P?L.firstElementChild:L),i=u(L.parentNode),p=L.parentNode.offsetWidth,a=L.getBoundingClientRect().top,r=P?L.firstElementChild.offsetWidth:L.offsetWidth,d=P?L.firstElementChild.offsetHeight:L.offsetHeight,m=8,l=!1;
x.innerText=f(W.nickname,48),R.onload=t,R.src=e,(R.complete||R.width)&&t();
}
}
...
p(E);
})),k.isInMiniProgram&&-1===S.indexOf(j)&&k.gtVersion("7.0.5",!0)&&y.on(B,"click",function(){
...
var A=null,q=function(){
A=null;
for(var e=0;e<N.length;e++){
var t=N[e].elem,o=t.tagName.toLowerCase(),i=t.firstChild&&1==t.firstChild.nodeType,p=i?1:"a"==o?2:0,a=N[e].elem.getBoundingClientRect();
if(a.top<j.getInnerHeight()&&a.bottom>0){
setTimeout(function(){
window.__addIdKeyReport&&window.__addIdKeyReport("28307",101);
},0);
var r=N[e].appid;
r&&K[r]&&K[r].nickname&&n(r,e,K[r].nickname,N[e].title,2,p),N.splice(e--,1);
}
}
};
q(),y.on(window,"scroll",function(){
A||(A=setTimeout(q,100));
});
},
onError:function(e){
...
function g(e,t){
for(var n=0;3>n;n++)b.removeClass(e,"weui-desktop-popover_pos-up-"+q[n]),b.removeClass(e,"weui-desktop-popover_pos-down-"+q[n]),
