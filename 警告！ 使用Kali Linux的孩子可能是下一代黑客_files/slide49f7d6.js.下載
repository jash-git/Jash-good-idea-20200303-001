...
});define("new_video/player.js",["page/pages/video.css","biz_common/utils/string/html.js","biz_wap/zepto/zepto.js","biz_wap/zepto/event.js","biz_wap/zepto/touch.js","biz_wap/jsapi/log.js","biz_common/dom/event.js","new_video/player.html.js","biz_wap/utils/device.js","new_video/ctl.js","biz_common/tmpl.js","pages/iframe_communicate.js","a/a_utils.js","biz_common/utils/url/parse.js","pages/version4video.js","biz_wap/utils/wapsdk.js","biz_common/base64.js","biz_wap/jsapi/core.js","new_video/plugin/util.js","biz_common/utils/monitor.js","common/utils.js"],function(e){
"use strict";
function t(){
o(),i();
}
...
t.pause4outer(),j.visibilityPausePlayer=t;
break;
}
}
}catch(i){}else{
var o=j.visibilityPausePlayer;
o&&o.hasBeginPlay()&&!o.isEnd()&&(o.play4outer(),j.visibilityPausePlayer=null);
}
}
...
t();
var F=function(e){
j._debug&&console.log(e);
},k=navigator.userAgent,M=function(){
return!0;
}(),x=(-1!==k.indexOf("Safari")&&-1!==k.indexOf("Version")&&-1==k.indexOf("Android"),
function(){
return!!_.browser.M1;
}()),D=function(e,t){
...
},N=!_.canSupportVideo,I=function(e){
...
if(r.setAttribute("origin_src",l),N)return s.find(".js_btn_play").attr("href",l).show(),
...
if(e&&e.autoplay||this.opt.autoplay||window.__auto_play__)return window.__auto_play__=!1,
this.videoCtlReport({
step:15
}),this._g.hasReportBeginPlay=!0,void this._trigger("readyBeginPlay",e);
if(this.opt.isVideoSharePage&&m.device.inWechat)return this.__firstLoadedFlowNoticeJudge(),
this.videoCtlReport({
step:15
}),this._g.hasReportBeginPlay=!0,void this._trigger("readyBeginPlay",e);
...
if(t&&t>0&&this.container.find(".js_video_length").html(E(t)).show(),1==this.__iosPreloadPause){
var i=this;
setTimeout(function(){
var e=i.container.find(".js_video_pause_controll");
e.hide();
var t=i.container.find(".js_video_play_controll");
t.show();
});
}
},
...
t.showLoading("firstTime"),this.showControllBar(),t.__firstLoadedFlowNoticeJudge(),
setTimeout(function(){
t.__continueSec&&(t.__replaySec=t.__continueSec,t.__continueSec=null),t._jsapiLog("set continue:"+t.__replaySec),
i.play();
},1);
},
...
e.log.duration=e.duration,e.duration=e.duration>>0,o.find(".js_total_time").text(E(e.duration)),
...
if(t.__forcePause===!0)return void F(t.id+":timeupdate __forcePause return");
if(t.__hasBeginPlay&&!t.__canplay)return t.showLoading(),!1;
n=t.video,null!=t.__replaySec&&(F(t.id+":timeupdate __replaySec"),n.pause(),n.currentTime=t.__replaySec,
...
F("player inner isend:"+t.isEnd()),t.isEnd()&&t.videoEnd();
...
t.showLoading(),t.showCover(),n.pause(),n.src=e,n.load(),n.play(),F(t.id+":stalled"));
}
}),e.on("seeked",function(){
t.__onTouch||t.opt.jsapiFullScreen&&t.__isInFullScreen||(t.changeStatus({
status:"loading",
subStatus:"seeked"
}),n.play()),F("video seeked event");
}),e.off("seeking").on("seeking",function(){
F("seeking,__hasBeginPlay:"+t.__hasBeginPlay),t.__hasBeginPlay&&(t.changeStatus({
status:"loading",
subStatus:"seeking"
}),t.showLoading());
}),e.off("waiting").on("waiting",function(){
if(F("waiting,__hasBeginPlay:"+t.__hasBeginPlay),t.__hasBeginPlay){
t.changeStatus({
status:"loading",
subStatus:"waiting"
...
},P),clearTimeout(t.waitingHandlerTimer),t.waitingHandlerTimer=null;
var e=0;
try{
...
var i=n.src;
t.showLoading(),t.showCover(),n.pause(),n.src=i,a++,n.load(),n.play(),F(t.id+":waitingHandlerTimer");
}
}
},1e4)),t._trigger("waiting");
}
}),e.off("play playing").on("play playing",function(e){
return t.__forcePause===!0||t._g.iosPreloadTmpPlay?void F(t.id+":play playing __forcePause return"):(t.changeStatus({
status:"play",
subStatus:e.type
}),setTimeout(function(){
t.adVideoStatus="play";
},10),F(t.id+":play playing"),o.removeClass("switch_on"),o.addClass("switch_off"),
t._hidePlayControllBar(),t.__startCountTime(),void t._trigger("play"));
}),e.off("pause").on("pause",function(){
t._g.iosPreloadTmpPlay||(F(t.id+":video pause event"),t.changeStatus({
status:"pause",
subStatus:""
}),setTimeout(function(){
...
n.find(".js_btn_play")),s=n.find(".js_btn_play_aria"),r=n.find(".js_video_poster"),l=n.find(".js_switch"),u=n.find(".js_progress_bar"),_=n.find(".js_controll"),h=(n.find(".js_played_bar"),
...
var v,w,y,T,b=0,P=0,j=0,C=i.__getDuration(),B=0,F=0,k=1,x=window.user_uin||0,D=0!==x&&Math.floor(x/100)%1e3<k,E=!1,I=0,V=!0,L=!1,H=null;
h.on("touchstart",function(e){
1==e.targetTouches.length&&i.isPlay()&&(o.blockTouchVideo||(H&&(clearTimeout(H),
H=null),y=v=new Date,T=w={
x:e.targetTouches[0].clientX,
y:e.targetTouches[0].clientY
},i._g.touchForwarding=!1,L=!0,V=!0,F=B=i.getCurTime()));
}),h.on("touchmove",function(e){
if(V&&1==e.targetTouches.length&&i.isPlay()&&!o.blockTouchVideo){
var t=new Date,n=e.changedTouches[0].clientX,a=e.changedTouches[0].clientY,s=Math.abs(n-T.x),r=Math.abs(a-T.y);
if(L&&(r>=10||r>s))return V=!1,void(L=!1);
H&&(clearTimeout(H),H=null),L=!1,i._g.touchForwarding=!0;
var l=t-v,d=n-w.x,u=a-w.y,_=Math.sqrt(Math.pow(d,2)+Math.pow(u,2))+j,h=Math.min(Math.ceil(_/l),6);
P=Math.floor(.1*_+.2*h*h*h)*Math.ceil(C/500),j=0==P?_:0,0>d&&(P=-P);
var c=180*Math.atan2(u,d)/Math.PI;
i._g.touchForwarding||(c>=-30&&30>=c&&++b,(c>=150&&180>=c||c>=-180&&-150>=c)&&--b,
(b>=4||-4>=b)&&(5>=_?b=0:(I=Math.max(I,h),i._g.touchForwarding=!0))),i._g.touchForwarding&&(B+=P,
0>B&&(B=0),B>C&&(B=1*C),i.__setForwardBar(B),e.preventDefault()),w={
x:n,
y:a
},v=t;
}
...
i.play(B);
},0),D&&(S.setSum(28307,29,1),!E)){
var t=(new Date,{
x:e.changedTouches[0].clientX,
y:e.changedTouches[0].clientY
}),o=t.x-T.x,n=t.y-T.y,a=parseInt(Math.sqrt(Math.pow(o,2)+Math.pow(n,2))),s=parseInt(180*Math.atan2(n,o)/Math.PI);
s>=-30&&30>=s||s>=150&&180>=s||s>=-180&&-150>=s||S.setSum(28307,35,1),S.setSum(28307,31,1),
S.setSum(28307,33,a),S.setSum(28307,34,I),E=!0;
}
...
i.hideTouchForward(),P=0,L=!1,i._g.touchForwarding=!1,V=!0,b=0;
}),h.on("touchmove MSPointerMove pointermove mousemove",function(e){
i.isInFullScreen()&&!M&&e.preventDefault();
...
return i.isInFullScreen()?M&&i.exitFullScreen():M&&(S.setSum(28307,56,1),i.enterFullScreen()),
e.preventDefault(),!1;
});
},
...
(l||d>=.5)&&(this.progressBarSeekData.dragTime=r,F("_pointerMoveHandler set currentTime, dragTime:"+this.progressBarSeekData.dragTime+" currentTime:"+this.video.currentTime),
...
this.progressBarSeekData=null,F("_pointerUpHandler dragTime:"+i+" currentTime:"+this.video.currentTime),
setTimeout(function(){
...
this.container.find(".js_now_play_time").text(E(e));
},
...
t.find(".js_forward").removeClass("none"),t.find(".total_time").text(E(i)),t.find(".js_forward_bar").css("width",100*o+"%"),
t.find(".js_forward_play_time").text(E(e));
},
...
if(o.__iosIsRealPreload&&s(o.video,!1),o.__forcePause=!1,o.opt.notPauseOtherVideoWhenPlay||p.broadcastMessage({
type:"broadcastPlay",
data:{
id:this.id
}
...
this._jsapiLog(a),F(a),p.broadcastMessage({
type:"statusChange",
data:{
id:this.id,
preStatus:o,
...
this.waitingHandlerTimer=null),e.pause(),F(this.id+":pause function"));
},
...
try{
if(s=parent.window.source||"",i=parent.window.msg_link.html(!1),o=parent.window.user_name||(window.cgiData?window.cgiData.username||window.cgiData.user_name:"")||"",
...
r._g.jsapiFullScreenId&&(clearTimeout(r._g.jsapiFullScreenId),r._g.jsapiFullScreenId=null),
/:ok$/.test(e.err_msg)?(r.__isInFullScreen=!0,r.onFullScreenChange({
state:!0,
type:"jsapi"
})):(r.__isInFullScreen=!1,_.os.android||r.play4outer(0/0,{
triggerEvent:!1
}),r._g.jsapiFullScreenErrCnt++);
...
j.visibilityPausePlayer===this&&(j.visibilityPausePlayer=null);
}
}),I._getFormatTime=E,I;
