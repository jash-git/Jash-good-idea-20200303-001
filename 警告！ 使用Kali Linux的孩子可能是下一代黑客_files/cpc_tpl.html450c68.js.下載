...
define("appmsg/reward_entry.js",["biz_common/dom/event.js","biz_wap/utils/ajax.js","biz_wap/jsapi/core.js","rt/appmsg/getappmsgext.rt.js","biz_wap/utils/mmversion.js","appmsg/appmsgext.js","appmsg/open_url_with_webview.js","common/utils.js","appmsg/pay_read_utils.js"],function(e,t,a,r){
"use strict";
function n(e){
...
pay_subscribe_uin_count:window.isPaySubscribe?3*x.getCountPerLine():0,
onSuccess:function(e){
e&&(j.rewardLink&&m.off(j.rewardLink,"click",z),j.authorAvatarLink&&m.off(j.authorAvatarLink,"click",R),
...
function o(e,t){
var a=function(){
H.src=t+"&qrcode_timestamp="+1*new Date+"#wechat_redirect";
},n=null;
return function(t){
...
a(),n=setInterval(a,12e4),r.classList[j.rewardLink.getBoundingClientRect().top<222?"add":"remove"]("reward_pop_bottom"),
r.classList.add(t);
var i=function d(a){
if(r.classList.contains(t)){
for(var i=a.target;null!==i&&i.id!==e;)i=i.parentNode;
(null===i||i.id!==e)&&(r.classList.remove(t),clearInterval(n),n=null,m.off(window,"click",d));
}
};
setTimeout(function(){
m.on(window,"click",i);
...
function s(e){
var t=window.innerWidth||document.documentElement.innerWidth,a=(Math.ceil((b.getInnerHeight()-188)/42)+1)*Math.floor((t-15)/42);
...
var w=j.rewardLink,y=j.authorAvatarLink;
if(w){
b.listenStateChange({
cb:function(e){
if("onResume"==e.state_change||"onResume"==e.state){
var t=(new Date).valueOf();
if(-1!=navigator.userAgent.indexOf("Android")&&localStorage.getItem("lastOnresumeTime")&&t-parseInt(localStorage.getItem("lastOnresumeTime"))<=L)return;
...
var x="/mp/authorreward?action=getqrcode&author_id="+k.author_id+"&rewardsn="+e.rewardsn+"&timestamp="+e.timestamp+"&__biz="+biz+"&appmsgid="+mid+"&idx="+idx+"&size=160";
if(z=o(s.replace(r,"&__tc=1"+r),x),R=o(s,x),m.on(w,"click",z),k.author_id&&1==e.can_reward&&y&&m.on(y,"click",R),
1==e.can_reward&&k.author_id&&j.reward){
n(document.getElementById("js_reward_author")),n(j.authorAvatarLink),j.rewardAuthorHead&&j.rewardAuthorHead.setAttribute("src",e.reward_author_head),
j.reward.classList.add("reward_area_primary");
var H=j.rewardLinkText;
H&&(H.innerText="喜欢作者",Math.random()<.05?H.innerText="稀罕作者":Math.random()>.05&&Math.random()<.1&&(H.innerText="钟意作者")),
j.rewardTotalText&&(j.rewardTotalText.innerText="人喜欢"),k.isWindowsWechat&&j.reward.classList.add("reward_area_win");
}
}
I=e.reward_head_imgs;
var A=c();
j.reward&&(k.author_id||h.isAndroid)&&1==e.can_reward?(n(j.reward),m.on(window,"load",function(){
_&&(m.off(window,"scroll",_),m.on(window,"scroll",_));
})):i(j.reward);
var S=document.getElementById("js_reward_inner");
!window.isPaySubscribe&&S&&A>0&&n(S);
var K=[].concat(I),C=document.getElementById("js_reward_total");
if(E=16*u,B=[].concat(I),C)if(C.innerText=e.reward_total,k.isWindowsWechat){
var M=C.parentNode;
M.dataset.hasEvent||!function(){
var t=document.getElementById("js_reward_pagination"),a=t.getElementsByClassName("js_reward_pagination_curpage")[0],r=Math.ceil(e.reward_total/E),n=1,i=!0,d=document.getElementById("js_reward_list"),o=function(t,a){
for(var n=(t-1)*E,o=i?3*u:0,s=document.createDocumentFragment(),c=n+o,_=t===r?e.reward_total:t*E;_>c;c++)l(s,a?window.defaultAvatarUrl:B[c]);
return!i&&(d.innerHTML=""),d.appendChild(s),i=!1,a?function(){
for(var e=d.getElementsByClassName("reward_user_avatar"),t=o,a=e.length;a>t;t++)e[t].firstElementChild.src=B[n+t];
}:!1;
};
...
var t=K.indexOf(e);
t>-1?K.splice(t,1):B.push(e);
}),"function"==typeof c&&c());
}
})):o(t);
};
A<e.reward_total&&!function(){
j.reward.classList.add("reward_avatar_overflow");
for(var o=d.children[0];1!==o.nodeType;)o=reward.nextElementSibling;
var s=getComputedStyle(o),l=o.offsetHeight+parseInt(s.marginBottom)+parseInt(s.marginTop);
T=function(t){
d.style.height="fold"===t?3*l+"px":r>n?l*Math.ceil(E/u)+"px":l*Math.ceil(e.reward_total%E/u)+"px";
},T("fold"),m.on(M,"click",function(){
j.reward.classList.contains("reward_avatar_unfold")?(j.reward.classList.remove("reward_avatar_unfold"),
r>1&&(t.style.display="none"),T("fold")):(1===n&&i&&_(n),j.reward.classList.add("reward_avatar_unfold"),
r>1&&(t.style.display=""),T("unfold"));
...
t&&(t.disabled=!1),T("unfold");
}
}else if(t.classList.contains("js_reward_pagination_next")&&(n++,a.innerHTML=n,_(n),
n===r&&(t.disabled=!0,T("unfold")),2===n)){
for(;t&&!t.classList.contains("js_reward_pagination_prev");)t=t.previousElementSibling;
t&&(t.disabled=!1);
}
});
}(),M.dataset.hasEvent=1;
}();
}else C.setAttribute("data-href",p),C.getAttribute("data-hasevent")||(m.on(C,"click",function(){
var e=C.getAttribute("data-href");
return v(e,{
sample:1,
reject:function(){
location.href=e;
...
}),C.setAttribute("data-hasevent",1));
}
function l(e,t){
...
if(a){
var i=j.reward.classList.contains("reward_avatar_unfold");
if("function"==typeof T&&T(i?"unfold":"fold"),!e){
for(var d=0,o=t.length;o>d&&(r++,l(n,t[d]),i||r!==3*u)&&r!==(E||16*u);++d);
...
e+b.getInnerHeight()>j.reward.offsetTop&&(f({
type:"GET",
...
e("biz_wap/utils/mmversion.js")),y=e("appmsg/appmsgext.js"),v=e("appmsg/open_url_with_webview.js"),b=e("common/utils.js"),x=e("appmsg/pay_read_utils.js"),k={
scene:window.source||"",
is_need_reward:!1,
...
},I=[],L=500,T=null,E=0,B=[];
window.logs&&(window.logs.reward_heads_total=0,window.logs.reward_heads_fail=0);
var z=function(){},R=function(){},H=document.getElementById("js_author_reward_qrcode_img");
return{
handle:function(e,t){
u=t,w(e),s(e);
},
