...
try{
var d=o("#img-content").getBoundingClientRect();
d.width&&(s=d.width);
}catch(w){
console.error(w);
}
var _=32,p=8,u='<div class="pay__tag-reward js_reward"></div>',c={
dom:{
...
for(var a=3*c.perLine,i="",n=0,t=r.pay_head_imgs.length;t>n;n++){
var o=r.reward_status_list?r.reward_status_list[n]:0;
if(i+='<div class="pay__avatar-wrp"><img src="'+r.pay_head_imgs[n]+'">'+(o?u:"")+"</div>",
n>=a-1)break;
}
e.wall.innerHTML=i;
},f=function(){
...
l("/mp/paysub?action=evaluate_show_page&__biz="+window.biz+"&mid="+window.mid+"&idx="+window.idx+"&sn="+window.sn+"&link="+encodeURIComponent(window.msg_link)+"&from_scene="+window.source+"&from_subscene="+window.subscene+"&is_fans="+window.isFans);
}),a.tap(e.rewardNum,function(){
var e=(Math.ceil((t.getInnerHeight()-188)/42)+1)*Math.floor((s-15)/42);
l("/mp/reward?act=getrewardheads&__biz="+window.biz+"&appmsgid="+window.mid+"&idx="+window.idx+"&sn="+window.sn+"&offset=0&count="+e+"&source=1");
});
},y=function(e,r,a){
...
e.rewardTotal=r.rewardTotal,e.rewardTotalCut=r.rewardTotalCut,c.data=e,t.wrap.style.height="",
t.wrap.style.marginTop="",t.wrap.style.visibility="visible",m(),!a&&f();
...
if(null===c.perLine){
var e=_+p;
c.perLine=Math.floor(.8*s/e),c.dom.wall.parentNode.style.width=c.perLine*e-p+"px";
}
return c.perLine;
};
return{
...
}("function"==typeof jQuery?jQuery:this);define("biz_common/utils/comm_report.js",[],function(){
"use strict";
var r=function(r,o){
...
d.appendChild(s);
var l=s.offsetWidth;
if(d.removeChild(s),l<.7*contentWrp.offsetWidth)return void commonUtils.report120081(15);
var c=document.createElement("mpcpc");
el_gdt_areas[utils.getPosKeyDesc(AD_POS.POS_MID)]=c,commonUtils.insertAfter(c,r),
...
error:function(){
log("[Ad] seeAd report error, tid="+tid+", aid="+aid+", pos_type="+pos_type),monitor.setSum(28307,27,1);
},
async:!0
