...
i(126+c,e.report_param)),u.setAvg(110696,2,n),o=!1;
...
for(var t=0;t<e.children.length;t++)if(-1!==n.indexOf(e.children[t].tagName))return!0;
}
function t(e,t){
...
for(var l,o=[],d=0;d<a.length;d++)l=a[d],l.isWrapper=void 0,i&&i.isMarkNode&&i.isMarkNode(l)||(e(l)&&!t(l,i)?(o=o.concat(r(l,i)),
i.getNestedStructure&&(l.isWrapper=!0,o.push(l))):o.push(l));
return o;
}
